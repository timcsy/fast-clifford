"""
Clifford Algebra Cl(2, 1) Functional Operations - Auto-generated
...
def geometric_product(a: Tensor, b: Tensor) -> Tensor:
    """
    Compute geometric product of two multivectors in Cl(2, 1).
...
def reverse(mv: Tensor) -> Tensor:
    """
    Compute reverse of a multivector in Cl(2, 1).
...
def involute(mv: Tensor) -> Tensor:
    """
    Compute grade involution of a multivector in Cl(2, 1).
...
def conjugate(mv: Tensor) -> Tensor:
    """
    Compute Clifford conjugate of a multivector in Cl(2, 1).
...
def inner(a: Tensor, b: Tensor) -> Tensor:
    """
    Compute inner product <ab>_0 in Cl(2, 1).
...
def outer(a: Tensor, b: Tensor) -> Tensor:
    """
    Compute outer product a ^ b in Cl(2, 1).
...
def contract_left(a: Tensor, b: Tensor) -> Tensor:
    """
    Compute left contraction a << b in Cl(2, 1).
...
def contract_right(a: Tensor, b: Tensor) -> Tensor:
    """
    Compute right contraction a >> b in Cl(2, 1).
...
def dual(mv: Tensor) -> Tensor:
    """
    Compute dual mv* = mv << I in Cl(2, 1).
...
def norm_squared(mv: Tensor) -> Tensor:
    """
    Compute norm squared |mv|^2 = <mv * ~mv>_0 in Cl(2, 1).
...
def compose_rotor(r1: Tensor, r2: Tensor) -> Tensor:
    """
    Compose two rotors r1 * r2 in Cl(2, 1).
...
def reverse_rotor(r: Tensor) -> Tensor:
    """
    Compute reverse of a rotor in Cl(2, 1).
...
def sandwich_rotor(r: Tensor, x: Tensor) -> Tensor:
    """
    Compute sandwich product r * x * ~r in Cl(2, 1).
...
def norm_squared_rotor(r: Tensor) -> Tensor:
    """
    Compute norm squared of a rotor in Cl(2, 1).
...
def exp_bivector(B: Tensor) -> Tensor:
    """
    Compute exponential of a bivector in Cl(2, 1).
...
def log_rotor(r: Tensor) -> Tensor:
    """
    Compute logarithm of a rotor in Cl(2, 1).
...
def slerp_rotor(r1: Tensor, r2: Tensor, t: Tensor) -> Tensor:
    """
    Spherical linear interpolation between rotors in Cl(2, 1).
