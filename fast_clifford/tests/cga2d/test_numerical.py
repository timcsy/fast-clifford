...
class TestSandwichProduct:
    ...
    def test_identity_motor(self):
        ...
        result = cga2d.sandwich_product_sparse(motor, point)
    ...
    def test_matches_full_product(self, reference_algebra):
        ...
        # Convert motor to sparse representation (7 components: G0 + G2)
    ...
    def test_batch_sandwich(self):
        ...
        result = cga2d.sandwich_product_sparse(motor, points)
...
class TestMotorReverse:
    """Test motor-specific reverse operation (7 components: G0 + G2)."""
